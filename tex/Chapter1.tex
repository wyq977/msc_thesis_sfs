...
\section{Approximation in Fourier-analytic Barron spaces with Bounded Weights}
...
at a cost of smaller hypothesis space which we define later in section
\ref{sec:diff_barron_spaces}. Tighter rates of approximation is made possible
with stricter conditions on the spectral norms while bounding the parameter
$b\in\R^d$ as in \TOCITE w.r.t. $L_1$ norm or $L_2$ norm.
