...
\begin{proof}
    ...
    Theorem 7.8 in the lecture notes of Measure Theory, Chapter 7 by Prof. Dr.
    John K. Hunter
    \url{https://www.math.ucdavis.edu/~hunter/measure_theory/measure_notes_ch7.pdf}},
    then for a function $h \in \lp{\infty}(\R)$, there exists a sequence of
    functions $s_n$ converge pointwise to $h$ for all $n \in \Nat$ and $x \in
    \R$
    \begin{align}
