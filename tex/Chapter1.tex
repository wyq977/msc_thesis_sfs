...
It also holds for the nowadays more popular ReLU activation function since $\sigma(z+1) - \sigma(z)$ is sigmoidal.
...
arbitrary precision under some mild restrictions\TOCITE. We will discuss these
conditions and compare to those to the classical representation theorems such poly

? what is the difference between the representation theorem and the Approximation theorem ??
% function on a compact set up to arbitrary precision [Cyb89, Fun89, HSW89,
% LLPS93].
% modern mathematics of deep learning
